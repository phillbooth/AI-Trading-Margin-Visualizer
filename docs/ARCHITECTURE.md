...
The target architecture below is still only partially implemented.
...
Treat the sections below as target service boundaries, not a claim that every runtime connection is already complete.
